...
function checkStuCapacity () {
    ...
    if(!partt02.test(StuCapacityValue)){
        ...
        $('.stuCapacityCheck').text('需要为整数，例如：1000')
...
function checkGraduatedStuNum () {
    ...
    if(!partt02.test(graduatedStuNumValue)){
        ...
        $('.graduateStuCheck').text('需要为整数，例如：1000')
...
function formSubmit() {
    ...
    if ( $('#getSuccessMsg').val() =='true' && checkSchoolNameResult == true && checkRepeatSchoolResult == true && checkFoundTimeResult == true &&
        checkIntCourseResult == true && checkIntResult == true && checkFloatResult == true && checkMuMeterResult == true && checkCourseResult == true &&
