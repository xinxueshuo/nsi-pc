...
$.ajax({
    ...
    success : function(msg){
        console.log(msg)
            ...
            $('#Name').val(autoDeleteZero(msg[0].Name)),
            $('#instutionLable').val(autoDeleteZero(msg[0].Label)),
            $('#institutionType').val(autoDeleteZero(msg[0].Type)),
            ...
            $('#Service').val(autoDeleteZero(msg[0].Service)),

            $('#ContactName').val(autoDeleteZero(msg[0].ContactName)),
            $('#ContactPosition').val(autoDeleteZero(msg[0].ContactPosition)),
            $('#ContactPhone').val(autoDeleteZero(msg[0].ContactPhone)),
            $('#ContactMail').val(autoDeleteZero(msg[0].ContactMail)),

            $('#Investment').val(autoDeleteZero(msg[0].Investment)),
            $('#Remark').val(autoDeleteZero(msg[0].Remark)),
            $('#ServedSchool').val(autoDeleteZero(msg[0].ServedSchool)),
            $('#Introduction').val(autoDeleteZero(msg[0].Introduction)),


            $('#alter_old_Institution_id').val(msg[0].Id)
...
function instutionFormAlter() {
    ...
    checkAddress()
    checkinstutionLable()
    if ( checkInstutionNameResult == true && checkFoundTimeResult == true && checkServiceResult == true &&
        ...
        var insertData = {
            ...
            "alter_old_Institution_id": $('#alter_old_Institution_id').val()
        ...
        $.ajax({
            ...
            url: 'http://'+changeUrl.address +'/Institution_api?whereFrom=alter',
            dataType: "jsonp",//数据类型为jsonp  
            jsonp: "Callback",//服务端用于接收callback调用的function名的参数  
